...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(8094015596772782)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8094354540772783)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8094609402772784)
,p_page_template_id=>wwv_flow_imp.id(8094015596772782)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8094918443772784)
,p_page_template_id=>wwv_flow_imp.id(8094015596772782)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8095202123772784)
,p_page_template_id=>wwv_flow_imp.id(8094015596772782)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8095559056772784)
,p_page_template_id=>wwv_flow_imp.id(8094015596772782)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8095809535772784)
,p_page_template_id=>wwv_flow_imp.id(8094015596772782)
,p_name=>'Left Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8096152524772784)
,p_page_template_id=>wwv_flow_imp.id(8094015596772782)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8096443139772784)
,p_page_template_id=>wwv_flow_imp.id(8094015596772782)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8096740369772784)
,p_page_template_id=>wwv_flow_imp.id(8094015596772782)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8097000784772784)
,p_page_template_id=>wwv_flow_imp.id(8094015596772782)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8097349727772785)
,p_page_template_id=>wwv_flow_imp.id(8094015596772782)
