...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8151651230772808)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8151965551772808)
,p_plug_template_id=>wwv_flow_imp.id(8151651230772808)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8152264985772808)
,p_plug_template_id=>wwv_flow_imp.id(8151651230772808)
,p_name=>'Tabs'
