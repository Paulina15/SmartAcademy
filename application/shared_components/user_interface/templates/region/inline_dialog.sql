...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8131834236772799)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8132173009772799)
,p_plug_template_id=>wwv_flow_imp.id(8131834236772799)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8132438716772799)
,p_plug_template_id=>wwv_flow_imp.id(8131834236772799)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8132778996772799)
,p_plug_template_id=>wwv_flow_imp.id(8131834236772799)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8133094789772799)
,p_plug_template_id=>wwv_flow_imp.id(8131834236772799)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8133304404772800)
,p_plug_template_id=>wwv_flow_imp.id(8131834236772799)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8133676092772800)
,p_plug_template_id=>wwv_flow_imp.id(8131834236772799)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8133955036772800)
,p_plug_template_id=>wwv_flow_imp.id(8131834236772799)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8134222884772800)
,p_plug_template_id=>wwv_flow_imp.id(8131834236772799)
,p_name=>'Sub Regions'
