...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8185162038772823)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8185451373772823)
,p_plug_template_id=>wwv_flow_imp.id(8185162038772823)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8185797374772823)
,p_plug_template_id=>wwv_flow_imp.id(8185162038772823)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8186068714772823)
,p_plug_template_id=>wwv_flow_imp.id(8185162038772823)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8186325360772823)
,p_plug_template_id=>wwv_flow_imp.id(8185162038772823)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8186669566772824)
,p_plug_template_id=>wwv_flow_imp.id(8185162038772823)
