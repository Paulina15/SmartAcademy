...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8191781410772826)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8192082086772826)
,p_plug_template_id=>wwv_flow_imp.id(8191781410772826)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8192342348772826)
,p_plug_template_id=>wwv_flow_imp.id(8191781410772826)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8192659641772826)
,p_plug_template_id=>wwv_flow_imp.id(8191781410772826)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8192902116772826)
,p_plug_template_id=>wwv_flow_imp.id(8191781410772826)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8193291192772826)
,p_plug_template_id=>wwv_flow_imp.id(8191781410772826)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8193527559772826)
,p_plug_template_id=>wwv_flow_imp.id(8191781410772826)
,p_name=>'Sub Regions'
