...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8121526214772795)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8121880783772795)
,p_plug_template_id=>wwv_flow_imp.id(8121526214772795)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8122106380772795)
,p_plug_template_id=>wwv_flow_imp.id(8121526214772795)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8122460072772795)
,p_plug_template_id=>wwv_flow_imp.id(8121526214772795)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8122792487772795)
,p_plug_template_id=>wwv_flow_imp.id(8121526214772795)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8123088784772795)
,p_plug_template_id=>wwv_flow_imp.id(8121526214772795)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8123352305772796)
,p_plug_template_id=>wwv_flow_imp.id(8121526214772795)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8123630150772796)
,p_plug_template_id=>wwv_flow_imp.id(8121526214772795)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8123942883772796)
,p_plug_template_id=>wwv_flow_imp.id(8121526214772795)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8124279569772796)
,p_plug_template_id=>wwv_flow_imp.id(8121526214772795)
,p_name=>'Sub Regions'
