...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8139835700772802)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8140171684772802)
,p_plug_template_id=>wwv_flow_imp.id(8139835700772802)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8140490283772802)
,p_plug_template_id=>wwv_flow_imp.id(8139835700772802)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8140748396772802)
,p_plug_template_id=>wwv_flow_imp.id(8139835700772802)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8141012329772803)
,p_plug_template_id=>wwv_flow_imp.id(8139835700772802)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8141321417772803)
,p_plug_template_id=>wwv_flow_imp.id(8139835700772802)
,p_name=>'Sub Regions'
