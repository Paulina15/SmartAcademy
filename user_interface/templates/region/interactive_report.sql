...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8183377398772822)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8183662278772822)
,p_plug_template_id=>wwv_flow_imp.id(8183377398772822)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8183994792772822)
,p_plug_template_id=>wwv_flow_imp.id(8183377398772822)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8184259938772823)
,p_plug_template_id=>wwv_flow_imp.id(8183377398772822)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8184559064772823)
,p_plug_template_id=>wwv_flow_imp.id(8183377398772822)
,p_name=>'Sub Regions'
