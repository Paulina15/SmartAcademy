...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8166599102772815)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8166849301772815)
,p_plug_template_id=>wwv_flow_imp.id(8166599102772815)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8167162420772815)
,p_plug_template_id=>wwv_flow_imp.id(8166599102772815)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8167483213772815)
,p_plug_template_id=>wwv_flow_imp.id(8166599102772815)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8167743668772815)
,p_plug_template_id=>wwv_flow_imp.id(8166599102772815)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8168002523772815)
,p_plug_template_id=>wwv_flow_imp.id(8166599102772815)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8168397631772815)
,p_plug_template_id=>wwv_flow_imp.id(8166599102772815)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8168667525772815)
,p_plug_template_id=>wwv_flow_imp.id(8166599102772815)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8168942242772816)
,p_plug_template_id=>wwv_flow_imp.id(8166599102772815)
,p_name=>'Sub Regions'
