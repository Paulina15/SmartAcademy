...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8171940674772817)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8172236338772817)
,p_plug_template_id=>wwv_flow_imp.id(8171940674772817)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8172510857772817)
,p_plug_template_id=>wwv_flow_imp.id(8171940674772817)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8172806351772817)
,p_plug_template_id=>wwv_flow_imp.id(8171940674772817)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8173181422772817)
,p_plug_template_id=>wwv_flow_imp.id(8171940674772817)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8173497078772818)
,p_plug_template_id=>wwv_flow_imp.id(8171940674772817)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8173702280772818)
,p_plug_template_id=>wwv_flow_imp.id(8171940674772817)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8174039048772818)
,p_plug_template_id=>wwv_flow_imp.id(8171940674772817)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8174389759772818)
,p_plug_template_id=>wwv_flow_imp.id(8171940674772817)
,p_name=>'Sub Regions'
