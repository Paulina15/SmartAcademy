...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8176587570772819)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8176887498772819)
,p_plug_template_id=>wwv_flow_imp.id(8176587570772819)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8177155715772819)
,p_plug_template_id=>wwv_flow_imp.id(8176587570772819)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8177405800772819)
,p_plug_template_id=>wwv_flow_imp.id(8176587570772819)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8177765363772819)
,p_plug_template_id=>wwv_flow_imp.id(8176587570772819)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8178033929772819)
,p_plug_template_id=>wwv_flow_imp.id(8176587570772819)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8178374210772820)
,p_plug_template_id=>wwv_flow_imp.id(8176587570772819)
,p_name=>'Sub Regions'
