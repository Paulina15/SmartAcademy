...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8136469316772801)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8136766603772801)
,p_plug_template_id=>wwv_flow_imp.id(8136469316772801)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8137095949772801)
,p_plug_template_id=>wwv_flow_imp.id(8136469316772801)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8137356006772801)
,p_plug_template_id=>wwv_flow_imp.id(8136469316772801)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8137625854772801)
,p_plug_template_id=>wwv_flow_imp.id(8136469316772801)
,p_name=>'Sub Regions'
