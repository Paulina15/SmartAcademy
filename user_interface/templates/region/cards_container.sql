...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8181784800772822)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8182061991772822)
,p_plug_template_id=>wwv_flow_imp.id(8181784800772822)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8182355117772822)
,p_plug_template_id=>wwv_flow_imp.id(8181784800772822)
,p_name=>'Sub Regions'
